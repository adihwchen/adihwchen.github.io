 ...
 * Build: http://modernizr.com/download/#-fontface-inlinesvg-svg-touch-shiv-mq-cssclasses-teststyles-prefixes-load
 */
;
window.Modernizr = function(a, b, c) {
    ...
    var d = "2.6.2",
        ...
        v = function(b) {
            ...
            if (c)
                return c(b).matches;
            var d;
            return u("@media " + b + " { #" + h + " { position: relative; } }", function(b) {
                d = (a.getComputedStyle ? getComputedStyle(b, null) : b.currentStyle)["position"] == "relative"
            }), d
        },
        w = {}.hasOwnProperty,
        x;
    !A(w, "undefined") && !A(w.call, "undefined") ? x = function(a, b) {
        ...
        var c;
        return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : u(["@media (", m.join("touch-enabled),("), h, ")", "{#modernizr{top:5%;position:absolute}}"].join(""), function(a) {
            c = a.offsetTop === 9
        }), c
    }, o.fontface = function() {
        var a;
    ...
    return e.addTest = function(a, b) {
        ...
        function q(a) {
            a || (a = b);
            var c = m(a);
            return r.shivCSS && !f && !c.hasCSS && (c.hasCSS = !!k(a, "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#0c387f;color:#000}")), j || p(a, c), a
        }
        var c = a.html5 || {},
